...
int numSpotLight;       // 繧ｹ繝昴ャ繝医Λ繧､繝医・謨ｰ縲・float4x4 mlvp[NUM_DIRECTIONAL_LIGHT][NUM_SHADOW_MAP];
float iblLuminance;     // IBL縺ｮ譏弱ｋ縺輔・int isIBL;              // IBL繧定｡後≧縲・int isEnableRaytracing; // 繝ｬ繧､繝医Ξ縺梧怏蜉ｹ縲・
