...
namespace nsK2Engine {
    ...
    void SceneLight::Init()
    {
        ...
        // @todo for test
        m_light.directionalLight[0].color.Set(Vector3::Zero);
      ...
      /*  m_light.directionalLight[1].color.x = 1.0f;
        ...
        // @todo for test
        m_light.ambinetLight.x = 0.00000001f;
        m_light.ambinetLight.y = 0.00000001f;
        m_light.ambinetLight.z = 0.00000001f;
